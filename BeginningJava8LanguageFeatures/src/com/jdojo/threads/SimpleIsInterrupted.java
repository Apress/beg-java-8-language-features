...
public class SimpleIsInterrupted {
	public static void main(String[] args) {
		...
		// Now check if it has been interrupted using the static method which will 
		// clear the interrupted status  
		System.out.println("#4:" + Thread.interrupted());		

		// Now, isInterrupted() should return false, because previous statement 
		// Thread.interrupted() has cleared the flag  
